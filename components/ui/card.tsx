...
const combineClasses = (baseClasses: string, additionalClasses?: string) => {
...
>(({ className, ...props }, ref) => (
  <div
    ref={ref}
    className={combineClasses("rounded-lg border bg-card text-card-foreground shadow-sm", className)}
    {...props}
  />
));
...
>(({ className, ...props }, ref) => (
  <p
    ref={ref}
    className={combineClasses("text-sm text-text-secondary", className)}
    {...props}
  />
));
